...
userRouter.get("/current", authenticateJwt_1.jwtAuthentication, userController_1.getUserInfo);
userRouter
    .route("/:userId")
    .get(authenticateJwt_1.jwtAuthentication, userController_1.getUserInfo)
